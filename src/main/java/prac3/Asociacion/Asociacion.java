...
public class Asociacion {
     ...
     */
    public Asociacion(String nombre, String correo, String[] titulaciones, String[] listaMiembros, String[] persCargos) {
    ...
    public Asociacion copia(){
        Asociacion asociacionCopia = new Asociacion(nombreAsociacion, correoContactoAsociacion, titulacionesAsociacion, listaMiembrosAsociacion, personasEnCargos);
