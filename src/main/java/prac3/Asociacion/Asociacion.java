...
public class Asociacion {
     ...
     * @param titulaciones  - Lista de informacion de las titulaciones (GEB, GEI,
     *                      GESST...)
     ...
     * @param fechaAlta     - Lista de las fechas de alta de los miembros de la
     *                      asociacion.
     * @param fechaBaja     - Lista de las fechas de baja de los miembros de la
     *                      asociacion.
     */
    ...
    public String toString() {
        ...
        for (int i = 0; i < listaMiembrosAsociacion.length; i++) {
            aux = aux + "\t\t\t\tMiembro " + (i + 1) + ": " + listaMiembrosAsociacion[i] + " con fecha de alta de "
                    + fechasAlta[i].toString();
     ...
     * @param fechaBaja - se pasa por parametro la fecha 99/99/9999 ya que al darse
     *                  de alta no hay intencion de darse de baja
     */
    public void addMiembroEnAsociacion(String alias, Fecha fechaAlta, Fecha fechaBaja) {
        ...
        if (!encontrado) {
            // Se crean nuevas tablas para los miembros de la asociacion i las fechas de
            // alta y baja con un espacio mas que antes
            ...
            // Se rellenan estas fechas con la informacion que ya tenian anteriormente, y se
            // deja el ultimo espacio vacio
            for (int i = 0; i < listaMiembrosAsociacion.length; i++) {
            ...
            // Se rellena el ultimo espacio con los datos del nuevo miembro que se quiere
            // inscribir en la asociacion
