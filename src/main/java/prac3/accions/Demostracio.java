...
public class Demostracio extends Accio {
     ...
     */
    public Demostracio(int indiceFichero, String tipoAccion, String nombreAccion, String[] asociacionesInvolucradas,
        ...
        this.fechaCreacion = new Data(fechaCreacion.getDia(), fechaCreacion.getMes(), fechaCreacion.getyear()); // Hay
                                                                                                                // que
                                                                                                                // crear
                                                                                                                // una
                                                                                                                // nueva
    ...
    public Demostracio copia() {
        return (new Demostracio(this.indiceFichero, this.tipoAccion, this.nombreAccion, this.asociacionesInvolucradas,
