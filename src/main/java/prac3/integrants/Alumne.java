...
public class Alumne extends Membre {
     ...
     */
    public Alumne(int indiceFichero, String tipoMiembro, String nombreMiembro, String alias, String correoMiembro,
            Data fechaAlta, Data fechaBaja, String curso, int yearsEtse, boolean graduado) {
     ...
     */
    public Alumne copia() {
        Alumne a = new Alumne(getIndiceFichero(), getTipoMiembro(), getnombreMiembro(), getAlias(), getCorreoMiembro(),
